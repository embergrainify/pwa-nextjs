  ...
  return (
    <>
      <Head>
        ...
        <link
          href={`${process.env.basePath}/icons/icon-16x16.png`}
          rel="icon"
          type="image/png"
          sizes="16x16"
        />
        <link
          href={`${process.env.basePath}/icons/icon-32x32.png`}
          rel="icon"
          type="image/png"
          sizes="32x32"
        />
        ...
        <link rel="apple-touch-icon" href={`${process.env.basePath}/icons/icon-192x192.png`}></link>
